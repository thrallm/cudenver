...
int main(){
	...
	char letterGrade;			// to store the letter grade
	...
	while (numOfGrades > MAXGRADE || numOfGrades < 1) // input validation
	{
...
//
// Exercise 1: Program is completed and the sample data produces the expected results.
